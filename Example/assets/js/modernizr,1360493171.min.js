...
else{i();executeStack();}}else{started=0;}}
...
if(resource['instead']){return resource['instead'](input,callback,chain,index,testResult);}else{if(scriptCache[resource['url']]&&resource['reexecute']!==true){resource['noexec']=true;}else{scriptCache[resource['url']]=1;}
...
window['yepnope']=getYepnope();window['yepnope']['executeStack']=executeStack;window['yepnope']['injectJs']=injectJs;window['yepnope']['injectCss']=injectCss;})(this,document);Modernizr.load=function()
